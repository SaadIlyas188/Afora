...
export default function IngredientsSpotlight() {
  ...
  return (
    <section ref={ref} className="py-10 md:py-32 px-6 md:px-12" style={{ backgroundColor: '#f7f3eb' }}>
      <div className="max-w-[1400px] mx-auto">
        <AnimatedSection className="text-center mb-8 md:mb-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-px bg-gold-200/40">
          {ingredients.map((ingredient, index) => (
            <motion.div
              ...
              className="bg-gold-50 p-4 md:p-10 group hover:bg-cream-200/50 transition-colors duration-500"
            >
